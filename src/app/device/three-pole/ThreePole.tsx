...
import { setDeviceId, setDeviceName } from '@/stores/device-store';
import { setSideMenuContent } from '@/stores/side-menu-store';

import { ThreePole1x } from './ThreePole1x';
import { ThreePole2x } from './ThreePole2x';
...
export const ThreePole: React.FC<IButtonIconProps> = (props) => {
    ...
    <div>
      {props.scale === '1x' ? (
        <ThreePole1x
          ...
          onClickButtonThree={() => {
            setKeyThreeStatus(!keyThreeStatus);
            handlerRpc(
              props.deviceId,
              !keyThreeStatus,
